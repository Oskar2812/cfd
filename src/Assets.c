...
//     double max = hist->bins[0];
//     double min = hist->bins[0];
...
//         char xAxisMarking[100];
//         sprintf(xAxisMarking, "%.2lf", hist->start + ii*inc / 10);
//         DrawLine(pos.x + offset + ii * (size.x - 2* offset)/ 10 , pos.y + size.y - offset,
//         pos.x + offset + ii* (size.x - 2* offset) / 10, pos.y + size.y - 0.9*offset, RAYWHITE);
//         DrawText(xAxisMarking, pos.x + offset + ii * (size.x - 2* offset) / 10, pos.y + size.y - offset, 1, RAYWHITE);
//     }
...
//         double y1, y2;
//         if(min < 0){
//             y1 = (pos.y + size.y - offset) - ((hist->bins[ii - 1] - min) / max) * (size.y - 2*offset);
//             y2 = (pos.y + size.y - offset) - ((hist->bins[ii] - min) / max) * (size.y - 2*offset);
//         } else {
//             y1 = (pos.y + size.y - offset) - (hist->bins[ii - 1] / max) * (size.y - 2*offset);
//             y2 = (pos.y + size.y - offset) - (hist->bins[ii] / max) * (size.y - 2*offset);
//         }
